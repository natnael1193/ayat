                ...
                <div className="container">
                    ...
                    <div className="navbar-collapse collapse justify-content-center" id="navbarDefault">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link " to="/propertyDetail">Property</Link>
                            </li>
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link dropdown-toggle" to="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
                                <div className="dropdown-menu">
                                    <Link className="dropdown-item " to="/property-single">Property Single</Link>
                                    <Link className="dropdown-item " to="/blog-single">Blog Single</Link>
                                    <Link className="dropdown-item " to="/agents-grid">Agents Grid</Link>
...
<Link className="navbar-brand text-brand" to="/">Ayat<span className="color-b"> Real State</span></Link>
                </div>
            </nav>
        </div>
    )
